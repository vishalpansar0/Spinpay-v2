...
@Component({
  ...
  styleUrls: ['./payslip.component.css','../../../../assets/css/main.css']
})
export class PayslipComponent implements OnInit {
  ...
  payslipData= this.fb.group({
    // payslip_num:['',[Validators.required]],
    payslip_image:['',[Validators.required]]
  });

  get payslip_image(){
    return this.payslipData.get('payslip_image'); 
  }
  ...
  submitImage(){
    ...
    this.regService.docUpload('api/payslip',formData).subscribe(
      success=>{
